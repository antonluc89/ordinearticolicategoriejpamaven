...
public class ArticoloServiceImpl implements ArticoloService {
	...
	@Override
	public Long cercaTuttiGliArticoliDiUnaCategoriaECalcolaLaSomma(Categoria categoriaInstance)
			throws Exception {
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
		...
		try {
			...
			return articoloDAO.findAllArticoliByCategoriaECalcolaSomma(categoriaInstance);
	...
	public List<Articolo> cercaTuttiGliArticoliConForeigKeyOrdineIsNull() throws Exception {
		...
		try {
			...
			return articoloDAO.findAllArticoliWhereForeigKeyOrdineIsNull();
